                ...
                <div className="flex flex-col md:flex-row">
                    <div className="w-full md:w-2/3 p-4">
                        <div className="relative w-full h-[300px] sm:h-[400px] md:h-[650px] bg-gray-900 rounded-xl overflow-hidden shadow-inner border border-white/10">
                            ...
                            >
                                ...
                                />
                                {/* ชั้นที่ 2: จุดไข่แดงตรงกลาง (ชัดๆ) */}
                                <Layer
                                    id="point-center"
                                    type="circle"
                                    paint={{
                                        'circle-radius': 6,
                                        'circle-color': 
                                            formData.impact === 'wide' ? '#ff0000' : // แดงเข้ม (วิกฤต)
                                            formData.impact === 'area' ? '#f97316' :   // ส้ม (ปานกลาง)
                                            '#22c55e',
                    ...
                    <div className="w-full md:w-1/3 p-4 bg-gray-800/50 backdrop-blur-sm">
                        <form onSubmit={handleIncidentSubmit} className="space-y-4">
                            <div>
                                <label className="block font-bold text-sm mb-1 text-gray-300">หัวข้อการแจ้งเหตุ</label>
                                <input
                            ...
                            <div>
                                <label className="block font-bold text-sm mb-1 text-gray-300">ขอบเขตผลกระทบ</label>
                                <select
                                    className="w-full bg-gray-900 text-gray-100 border border-gray-600 p-3 rounded-xl outline-none"
                                    value={formData.impact}
                                    onChange={e => setFormData({...formData, impact: e.target.value})}
                                >
                                    <option value="point">รัศมีเฉพาะจุด</option>
                                    <option value="area">รัศมีปานกลาง</option>
                                    <option value="wide">รัศมีวงกว้าง</option>
                                </select>
                            </div>
